 ...
 */
public class CustomYoutubeAudioTrack extends DelegatedAudioTrack {
  private static final Logger log = LoggerFactory.getLogger(CustomYoutubeAudioTrack.class);

  private final CustomYoutubeAudioSourceManager sourceManager;

  /**
   * @param trackInfo Track info
   * @param sourceManager Source manager which was used to find this track
   */
  public CustomYoutubeAudioTrack(AudioTrackInfo trackInfo, CustomYoutubeAudioSourceManager sourceManager) {
    super(trackInfo);
  ...
  public void process(LocalAudioTrackExecutor localExecutor) throws Exception {
    try (HttpInterface httpInterface = sourceManager.getHttpInterface()) {
      ...
      System.out.println("Starting track from URL: {}" + format.signedUrl);
  ...
  protected AudioTrack makeShallowClone() {
    return new CustomYoutubeAudioTrack(trackInfo, sourceManager);
  }
